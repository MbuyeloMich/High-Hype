      ...
      >
        ...
        <div className="flex flex-col flex-grow px-6 pt-8">
          ...
          <div ref={el => mobileMenuItemsRef.current[6] = el} className="border-t border-white/10 pt-6 flex flex-col gap-3 mt-auto mb-10">
            <a href="mailto:hello@highhype.studio" className="flex items-center gap-3 px-4 py-2 text-sm text-gray-400 hover:text-white transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
              hello@highhype.studio
            </a>
      ...
      >
        ...
        >
          ...
          <div ref={el => menuItemsRef.current[5] = el} className="border-t border-white/10 pt-4 flex flex-col gap-2">
            <a href="mailto:hello@highhype.studio" className="flex items-center gap-3 px-4 py-2 text-xs text-gray-400 hover:text-white transition-colors">
