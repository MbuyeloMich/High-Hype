...
export default function About() {
  ...
  return (
    <section ref={container} id="about" className="w-full py-20 md:py-24 px-4 md:px-6 bg-base-pure">
      <div className="max-w-[1600px] mx-auto">
        <div className="mb-12 md:mb-16">
          <p className="about-eyebrow font-mono text-xs uppercase tracking-[0.2em] text-muted mb-6">// The studio</p>
