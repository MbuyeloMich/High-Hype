  ...
  return (
    <>
      <SEO
        title="Projects"
        path="/projects"
        description="Selected client and concept work from High Hype. Brand, product, and web for founders and product teams."
      />
      <h1 className="sr-only">Projects — High Hype Studio</h1>
      <WorkShowcase />
    </>
  )
}
